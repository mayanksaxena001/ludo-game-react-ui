...
function NewDashBoard(props) {
    ...
    const { Heart, Egg, WhiteEgg, WhiteOvalEgg, PinkSapphireDiamond, Banana, MessageBubble, InboxMessage, OldEnvelopeEmailIcon, BorderOnlyMessageIcon, GameSettingsIcon } = fetchSvgs();
...
function fetchSvgs() {
    ...
    return { Heart, Egg, WhiteEgg, WhiteOvalEgg, PinkSapphireDiamond, Banana, MessageBubble, InboxMessage, OldEnvelopeEmailIcon, BorderOnlyMessageIcon, GameSettingsIcon };
}
