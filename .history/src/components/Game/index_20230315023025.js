...
function LudoGame(props) {
    ...
    function handleTimeOut = useCallback(() => {
        console.log('Timeout..');
    ...
    if (!gameStarted) {
        ...
        return (
            <SocketChannelContext.Provider value={socket}>
                <GameBoard id={gameData.game.id} player={player} playerTurn={playerTurn} handleTokenMove={handleTokenMove} isDisabled={isDisabled} gameData={gameData} dicehandler={dicehandler} handleTimeOut={handleTimeOut} />
