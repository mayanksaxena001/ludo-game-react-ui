    ...
    if (!gameStarted) {
        ...
        return (
            <SocketChannelContext.Provider value={socket}>
                <GameBoard room={room} id={user.id} player={player} playerTurn={playerTurn} handleTokenMove={handleTokenMove} disabled={isDisabled} gameData={gameData} dicehandler={dicehandler} />
