    ...
    if (!gameStarted) {
        ...
        return (
            <SocketChannelContext.Provider value={socket}>
                <GameBoard room={room} id={'xyz'} handleTokenMove={handleTokenMove} disabled={!gameStarted || gameData.player_turn == playerTurn} gameData={gameData} dicehandler={dicehandler} />
