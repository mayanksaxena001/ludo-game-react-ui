...
function VerticalPath(props) {
    ...
    let className = '';
    const COLORED_BOXES_ID = new Map();
    if (id === '1') {
        COLORED_BOXES_ID.set(7,color);
    ...
    const VPath1 = <div className='vpath'>
        <PathBox id='1' color={COLORED_BOXES_ID.get(1)} value={id} minheight={height} minWidth={width} />
    ...
    const VPath2 = <div className='vpath'>
        <PathBox id='7' color={COLORED_BOXES_ID.get(7)} value={id} minheight={height} minWidth={width} />
