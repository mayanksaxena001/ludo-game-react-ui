  ...
  const tokenBox = () => {
    ...
    return <>
      <div className='tokens'>
        <Box height={minHeight} width={minWidth} tokens={token1} handleTokenMove={handleTokenMove} />
        <Box height={minHeight} width={minWidth} tokens={token2} handleTokenMove={handleTokenMove} />
      </div>
      <div className='tokens'>
        <Box height={minHeight} width={minWidth} tokens={token3} handleTokenMove={handleTokenMove} />
        <Box height={minHeight} width={minWidth} tokens={token4} handleTokenMove={handleTokenMove} />
      </div>
    </>
  }
  return (
