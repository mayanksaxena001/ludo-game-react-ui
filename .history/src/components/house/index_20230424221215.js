  ...
  const tokenBox = () => {
    ...
    return <>
      <div className='tokens'>
        <Box playerTurn={player.player_turn === data.player_turn} height={minHeight} width={minWidth} tokens={token1} handleTokenMove={handleTokenMove} />
        <Box playerTurn={player.player_turn === data.player_turn} player={player} height={minHeight} width={minWidth} tokens={token2} handleTokenMove={handleTokenMove} />
      </div>
      <div className='tokens'>
        <Box playerTurn={player.player_turn === data.player_turn} player={player} height={minHeight} width={minWidth} tokens={token3} handleTokenMove={handleTokenMove} />
        <Box playerTurn={player.player_turn === data.player_turn} player={player} height={minHeight} width={minWidth} tokens={token4} handleTokenMove={handleTokenMove} />
      </div>
    </>
  }
  return (
