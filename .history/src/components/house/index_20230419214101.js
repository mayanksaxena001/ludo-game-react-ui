  ...
  const tokenBox = () => {
    ...
    return <>
      <div className='tokens'>
        <Box color={color} height={height} width={width} tokens={token1} />
        <Box color={color} height={height} width={width} tokens={token2} />
      </div>
      <div className='tokens'>
        <Box color={color} height={height} width={width} tokens={token3} />
        <Box color={color} height={height} width={width} tokens={token4} />
      </div>
    </>
  }
  return (
