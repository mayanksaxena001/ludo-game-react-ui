  ...
  const tokenBox = () => {
    ...
    return <>
      <div className='tokens'>
        <Box color={color} height={height} width={width} tokens={token1} handleTokenMove={handleTokenMove} />
        <Box color={color} height={height} width={width} tokens={token2} handleTokenMove={handleTokenMove} />
      </div>
      <div className='tokens'>
        <Box color={color} height={height} width={width} tokens={token3} handleTokenMove={handleTokenMove} />
        <Box color={color} height={height} width={width} tokens={token4} handleTokenMove={handleTokenMove} />
      </div>
    </>
  }
  return (
