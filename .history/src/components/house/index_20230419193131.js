  ...
  const tokenBox = () => {
    return <>
      <div className='tokens'>
        <Box id={id} value={1} color={color} minheight={height} minWidth={width} />
        <Box id={id} value={2} color={color} minheight={height} minWidth={width} />
      </div>
      <div className='tokens'>
        <Box id={id} value={3} color={color} minheight={height} minWidth={width} />
        <Box id={id} value={4} color={color} minheight={height} minWidth={width} />
      </div>
    </>
  }
  return (
