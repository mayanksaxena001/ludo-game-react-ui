...
function House(props) {
  ...
  const displayProgressbar = () => {
    ...
    if (player && data && data.has_started && player.active && player.player_turn === data.player_turn) return <ProgressBar key={id} bgcolor={color} handleTimeOut={handleTimeOut} data={data} />
  }
