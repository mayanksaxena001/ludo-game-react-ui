...
function House(props) {
  ...
  const isPlayerActive = () => {
    return player != null ? player.active : false;
  }
  ...
  return (
    <div disabled={isPlayerActive()} className={getHouseClass()} style={{ borderColor: color, height: { height }, minHeight: { minHeight_ }, maxHeight: { maxHeight }, width: { width }, minWidth: { minWidth_ }, maxWidth: { maxWidth } }}>
