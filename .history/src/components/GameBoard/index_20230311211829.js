...
function GameBoard(props) {
  const { id, userId, room, playerIds, tokencount, disabled, gameData, dicehandler } = props;
      ...
      <div className='board'>
        ...
        <div className='center-board-houses'>
          ...
          <div className='center-path'>
            <DiceRoller room={room} dicehandler={dicehandler} disabled={gameData.player_turn == userId} />
          </div>
