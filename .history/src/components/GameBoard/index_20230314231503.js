...
function GameBoard(props) {
  const { id, playerTurn, player, disabled, gameData, dicehandler, handleTokenMove } = props;
    ...
    <div className='game-board' disabled={disabled}>
      <div className='board'>
        ...
        <div className='center-board-houses'>
          ...
          <div disabled={disabled} className='center-path'>
            <DiceRoller dicehandler={dicehandler} disabled={disabled} />
          </div>
