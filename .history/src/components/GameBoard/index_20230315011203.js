...
function GameBoard(props) {
  const { id, playerTurn, player, isDisabled, gameData, dicehandler, handleTokenMove,handleTimeOut } = props;
    ...
    <div className='game-board' >
      <div className='board'>
        <div className='board-houses-1'>
          <House player={player} id={player2Id} value={player2_name} color={color2} minheight={height} minWidth={width} data={gameData} handleTokenMove={handleTokenMove} handleTimeOut={handleTimeOut}/>
