    ...
    <div className='game-board'>
      <div className='board'>
        <div className='board-houses-1'>
          ...
          <VerticalPath id='4' color={color4} height={height} width={width} />
          <House id='2' value='1' color={color4} minheight={height} minWidth={width} />
        </div>
        <div className='center-board-houses'>
          <HorizontalPath id='1' color={color1} height={height} width={width} />
          <div className='center-path' />
          <HorizontalPath id='3' color={color3} height={height} width={width} />
        </div>
        <div className='board-houses-2'>
          <House id='3' value='1' color={color2} minheight={height} minWidth={width} />
          <VerticalPath id='2' color={color2} height={height} width={width} />
