    ...
    <div className='game-board'>
      <div className='board'>
        <div className='board-houses-1'>
          <House  id='1' value='1'  color = 'yellow' minheight={height} minWidth={width}/>
          <VerticalPath id='1'  color = 'yellow'  height={height} width={width}/>
          <House  id='2' value='1'  color = 'green' minheight={height} minWidth={width}/>
        </div>
        ...
        <div className='board-houses-2'>
          <House  id='3' value='1'  color = 'Red' minheight={height} minWidth={width}/>
          <VerticalPath  id='2'   color = 'blue' height={height} width={width}/>
          <House  id='4' value='1'  color = 'blue' minheight={height} minWidth={width}/>
        </div>
